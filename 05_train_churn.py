...
file_handler = logging.FileHandler(os.path.join(LOG_DIR, '05_train_churn.log'))
...
def train_churn_model(spark):
    ...
    assembler = VectorAssembler(inputCols=["LastPurchase"], outputCol="features") # Add other features here
